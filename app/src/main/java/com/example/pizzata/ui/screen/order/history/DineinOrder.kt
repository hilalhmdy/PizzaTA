...
import com.example.pizzata.model.OrderDineIn
import com.example.pizzata.model.OrderFinish
import com.example.pizzata.model.dummyOrderDineIn
...
fun DineInOrderScreen() {
    Column(
        ...
        ListOrderDineIn(dummyOrderDineIn)
    }
}

@Composable
fun ListOrderDineIn(
    listOrderFinish: List<OrderDineIn>,
